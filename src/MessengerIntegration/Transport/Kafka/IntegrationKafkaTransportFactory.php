...
class IntegrationKafkaTransportFactory implements TransportFactoryInterface
{
    private const DSN_PROTOCOLS = [
        self::DSN_PROTOCOL_KAFKA,
        self::DSN_PROTOCOL_KAFKA_SSL,
    ];
    private const DSN_PROTOCOL_KAFKA = 'integration-kafka://';
    private const DSN_PROTOCOL_KAFKA_SSL = 'integration-kafka+ssl://';
